...
import {ColorTokens, Theme} from './model/theme.interface';

export type AvailableThemeType = 'light' | 'dark';
...
export const themeSettings = (mode: AvailableThemeType): Theme => {
    ...
    palette: {
      ...
      ...(mode === 'dark'
        ...
        : {
            ...
            background: '#fcfcfc',
            card: colors.grey[700],
            text: colors.primary[100],
          }),
    },

    typography: {
      fontFamily: ['Souce Sans 3', 'sans-serif'].join(','),
      fontSize: 12,
      h1: {
        fontFamily: ['Souce Sans 3', 'sans-serif'].join(','),
        fontSize: 40,
